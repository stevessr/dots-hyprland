...
printf '您好！\n'
printf '本脚本 1. 将卸载 [end-4/dots-hyprland > illogical-impulse] 点文件\n'
printf '        2. 将尝试恢复使用 install.sh 安装的*几乎所有内容*，因此它具有相当大的破坏性\n'
...
printf '\e[36m正在从 video、i2c 和 input 组中删除用户并删除软件包...\n\e[97m'
user=$(whoami)
