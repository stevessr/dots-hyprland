            ...
            Item { // Queries awaiting response
                ...
                Rectangle {
                    ...
                    StyledText {
                        ...
                        wrapMode: Text.Wrap
                        text: qsTr("%1 个查询待处理").arg(Booru.runningRequests)
                    }
                }
            }
        }
        ...
        Rectangle { // Tag input area
            ...
            RowLayout { // Input field and send button
                ...
                StyledTextArea { // The actual TextArea
                    ...
                    placeholderText: qsTr('输入标签，或输入“%1”查看命令').arg(root.commandPrefix)
