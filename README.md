...
<div align="center">
 ...
 <details> 
  ...
  - **NEW**: Niri support - Alternative scrollable-tiling compositor configuration available in `.config/niri/`
</details>
<details> 
  <summary>Installation instructions</summary>

   - See the [Wiki](https://end-4.github.io/dots-hyprland-wiki/en/ii-qs/01setup/) for Hyprland installation
   - **For Niri**: See [.config/niri/README.md](.config/niri/README.md) for niri-specific setup
...
<details>
  ...
  | [Niri](https://github.com/YaLTeR/niri) | **NEW**: Alternative scrollable-tiling compositor (see `.config/niri/`) |
